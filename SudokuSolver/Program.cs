...
namespace SudokuSolver {
    class Program {
        private const string fromPaper = "060001020970820400035004001604000018007000200820000605700900130002067094040500080";
        ...
        static void Main(string[] args) {
            Sudoku mySoduku = new Sudoku(diabolic2);
            mySoduku.PrintGrid();
            mySoduku.SolveRecursively();
            mySoduku.SolveByElimination();
        }
    }
}
